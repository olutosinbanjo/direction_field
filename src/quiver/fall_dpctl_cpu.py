...
@method: matplotlib.pyplot.quiver (MPQ) + dpctl{cpu}
...
def other_solutions(X, Y, dx, dy, function):
    ...
    plt.title(f'dpctl_cpu: Direction Field and Equilibrium Solution for {function}')
    #plt.show()
...
if __name__ == "__main__":
    ...
    try:
        ...
        with dpctl.device_context("opencl:cpu") as cpu_queue:
            print("Plotting with data parallel control on cpu device...\n")
            print("Device :\n")
